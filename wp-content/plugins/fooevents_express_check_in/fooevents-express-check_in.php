...
class FooEvents_Express_Check_in {
    ...
    public function plugin_init() {
        ...
        $this->UpdateHelper = new FooEvents_Express_Check_in_Update_Helper($this->Config);
    ...
    public function register_scripts_and_styles() {
        ...
        if(!empty($_GET['page'])) {
            ...
            if ($_GET['page'] == 'fooevents-express-checkin-page') {
                ...
                wp_enqueue_script('fooevents-express-check-in-admin-script',  $this->Config->scriptsPath . 'check-in-admin.js', array('jquery'), '1.4.6', true);
                wp_enqueue_style('fooevents-express-check-in-admin-style',  $this->Config->stylesPath . 'check-in-admin.css', array(), '1.4.6');
