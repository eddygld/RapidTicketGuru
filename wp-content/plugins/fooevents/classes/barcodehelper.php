...
class FooEvents_Barcode_Helper {
    ...
    public function generate_QR($text = 0, $prefix ='') {
        ...
        if (!class_exists('QRcode')) {
            ...
            require_once($this->Config->vendorPath.'/phpqrcode/phpqrcode.php');
        ...
        QRcode::png($text, $this->Config->barcodePath.$filename.'.png',  QR_ECLEVEL_L, 6); 
        $this->png2jpg($this->Config->barcodePath.$filename.'.png', $this->Config->barcodePath.$filename.'.jpg');
	...
	imagepng($image, $this->Config->barcodePath.$filename.'.png');
	imagejpeg($image, $this->Config->barcodePath.$filename.'.jpg');
