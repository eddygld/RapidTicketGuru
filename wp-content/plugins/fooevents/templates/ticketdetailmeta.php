...
<table class="form-table">
	<tbody>     
            ...
            <tr valign="top">  
                <td style="width: 200px;" valign="top">
                    <label><?php _e('Check In Time:', 'woocommerce-events'); ?></label><Br />
                </td>
                <td>
                    <?php foreach($checkinTimes as $day => $time) :?>
                    <?php _e('Day ', 'woocommerce-events'); ?><?php echo $day; ?> <?php echo $time; ?>
                    <?php endforeach; ?>
                </td>
            </tr>
...
<table class="form-table">
	<tbody>     
            ...
            <?php if (!empty($WooCommerceEventsZoomText)) : ?>
                <tr valign="top">  
                    <td style="width: 200px;vertical-align:top;">
                        <label><?php _e('Zoom Meetings/Webinars:', 'woocommerce-events'); ?></label><Br />
                    </td>
                    <td style="word-break:break-word;">
                        <?php echo nl2br($WooCommerceEventsZoomText); ?>
                    </td>
                </tr>
            <?php endif; ?> 
            <tr valign="top">  
                <td style="width: 200px;">
                    <?php _e('Download ICS:', 'woocommerce-events'); ?>
                </td>
                <td>
                    <a href="<?php echo esc_attr($icsURL.$WooCommerceEventsTicketID); ?>.ics" target="_BLANK">#<?php echo esc_attr($WooCommerceEventsTicketID); ?></a>
                </td>
            </tr>
	</tbody>
</table>