<table cellpadding="0" cellspacing="0" style="border:10px solid <?php echo $ticket['WooCommerceEventsTicketBackgroundColor']; ?>;font-family:<?php echo $font_family; ?>;max-width:621px;border-collapse:collapse" class="contenttable">
    <tr>
        <td>
                ...
                <tr>
                    ...
                    <td style="background-color:#ffffff">
                        <table width="260" border="0" cellspacing="20" cellpadding="0" align="left" style="background-color:#ffffff;border-collapse:separate" class="contenttable">
                            ...
                            <tr>
                                    <td align="center" style="width:154px;" width="154"><img style="display:block;" src="<?php echo $barcodeURL; ?><?php echo $ticket['barcodeFileName']; ?>.png"  style="width:154px;" width="154"/></td>
                            </tr>
                            <?php endif; ?>
                        </table>
                                ...
                                <td>
                                    <table width="260" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color:#ffffff;border-collapse:collapse" class="contenttable contenttable_text_inner">
                                        <?php if($ticket['WooCommerceEventsTicketDisplayDateTime'] != 'off') :?>
                                            <tr><td style="font-weight:bold;font-size:16px"><?php echo $ticket['WooCommerceEventsDate']; if(!empty($ticket['WooCommerceEventsEndDate'])) : echo " - " . $ticket['WooCommerceEventsEndDate']; endif; ?></td></tr>
                                        ...
                                        <tr>
                                            <td>
                                                <table width="150" border="0" cellspacing="0" cellpadding="9" align="left" style="background-color:<?php echo $ticket['WooCommerceEventsTicketButtonColor']; ?>;border-collapse:collapse">
                                                    ...
                                                    <tr>
                                                            <td align="center">
                                                                    <a href="<?php echo site_url(); ?>/wp-admin/admin-ajax.php?action=fooevents_ics&event=<?php echo $ticket['WooCommerceEventsProductID']; ?><?php echo !empty($ticket['WooCommerceEventsAttendeeEmail']) ? '&email=' . urlencode($ticket['WooCommerceEventsAttendeeEmail']) : ''; ?>" style="color:<?php echo $ticket['WooCommerceEventsTicketTextColor']; ?>;text-decoration:none;font-size:16px"><?php _e('Add to calendar', 'woocommerce-events'); ?></a>
                                                            </td>
                                                    </tr>
                                                    <?php endif; ?>
                                                </table>
