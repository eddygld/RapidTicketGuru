...
<?php if(!empty($WooCommerceEventsHour) && !empty($WooCommerceEventsMinutes) && $WooCommerceEventsHour != '00') :?>
    ...
    <p><b><?php _e('Start time:', 'woocommerce-events'); ?> </b> <?php echo esc_attr($WooCommerceEventsHour).':'.esc_attr($WooCommerceEventsMinutes); ?> <?php echo (!empty($WooCommerceEventsPeriod))? esc_attr($WooCommerceEventsPeriod) : '' ?> <span class="fooevents-tab-timezone" title="<?php echo $WooCommerceEventsTimeZone; ?>"><?php echo $timeZone; ?></span></p>

<?php endif; ?>
    
<?php if(!empty($WooCommerceEventsHourEnd) && !empty($WooCommerceEventsMinutesEnd) && $WooCommerceEventsHourEnd != '00') :?>

    <p><b><?php _e('End time:', 'woocommerce-events'); ?> </b> <?php echo esc_attr($WooCommerceEventsHourEnd).':'.esc_attr($WooCommerceEventsMinutesEnd); ?> <?php echo (!empty($WooCommerceEventsEndPeriod))? esc_attr($WooCommerceEventsEndPeriod) : '' ?> <span class="fooevents-tab-timezone" title="<?php echo $WooCommerceEventsTimeZone; ?>"><?php echo $timeZone; ?></span></p>
